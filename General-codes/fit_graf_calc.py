...
#LECTURA DE .mat:
"""
data = loadmat('datos_laboratorio.mat')

#Los datos se extraen usando las llaves (nombres de variable en MATLAB)
X = data['tiempo'].flatten() #flatten() asegura que sea un array simple
Y = data['voltaje'].flatten()
"""

#GUARDADO DE IMAGEN:
"""
Ajuste.fig.savefig('Ajuste.pdf', dpi=300)
"""
